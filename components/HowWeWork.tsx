    ...
    <section id="how" className="bg-white py-28">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            <h2
              className="font-serif font-light leading-[1.14] text-[#0A1520] mb-5"
              style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)" }}
            >
              Remote-First.{" "}
              <em className="italic text-[#1E3A5F]">Available In-Person.</em>
            </h2>
            <p className="text-[0.97rem] font-light leading-[1.8] text-[#4A6070] max-w-[480px]">
            ...
            {/* Commitment note */}
            <div className="mt-8 pl-5 border-l-[3px] border-[#1E3A5F] bg-[#F6F7F9] p-5">
              <p className="text-[0.87rem] font-light leading-[1.72] text-[#253545]">
          ...
          <div>
            <p className="text-[0.7rem] font-semibold tracking-[0.16em] uppercase text-[#4A6070] mb-5">
              Engagement Options
            </p>
            <ul className="flex flex-col gap-4">
              {engagements.map((item) => (
                <li
                  key={item}
                  className="flex items-start gap-4 text-[0.92rem] font-light leading-[1.65] text-[#253545]"
                >
                  <span className="mt-[0.1rem] text-[#1E3A5F] font-semibold flex-shrink-0">
                    →
                  </span>
                  {item}
                </li>
            ...
            <div className="mt-10 pt-8 border-t border-[#E2E8F0]">
              <blockquote className="font-serif italic text-[1.15rem] text-[#253545] leading-relaxed mb-3">
